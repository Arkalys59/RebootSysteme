...
function checkreboot()
	...
	if date_local == '07:25:00' or date_local == '17:25:00' then
		TriggerClientEvent('reboot:startRain', -1)
	elseif date_local == '07:36:00' or date_local == '17:36:00' then
		TriggerClientEvent('reboot:startThunder', -1)
	elseif date_local == '07:40:00' or date_local == '17:40:00' then
		TriggerClientEvent('reboot:startThunder', -1)
	elseif date_local == '07:45:00' or date_local == '17:45:00' then
		TriggerClientEvent('esx:showNotification', -1, "~r~Le serveur reboot automatiquement dans 15 minutes !")
	elseif date_local == '07:50:00' or date_local == '17:50:00' then
		TriggerClientEvent('esx:showNotification', -1, "~r~Le serveur reboot automatiquement dans 10 minutes !")
	elseif date_local == '07:55:00' or date_local == '17:55:00' then
	...
	elseif date_local == '07:59:40' or date_local == '17:59:40' then
		ESX.SavePlayers()
...
-- AddEventHandler('reboot:checkStatus', function()
	...
	-- if heure == '05' or heure == '11' or heure == '17' or heure == '01' then
		...
		-- end
		-- Wait(45000)
		-- TriggerClientEvent('esx:showNotification', -1, "Alerte tempête veuillez suivre les procedures")
	-- end
-- end)